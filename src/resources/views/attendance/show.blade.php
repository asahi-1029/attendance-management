                    ...
                    <div class="attendance-detail__list">
                            ...
                            <div class="{{ $isPending ? 'attendance-detail__value--view' : 'attendance-detail__value' }}">
                                ...
                                @else
                                    <div class="input-wrap">
                                        ...
                                        <div class="form__error">@error('clock_in') {{ $message }} @enderror</div>
                                    </div>
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <div class="form__error">@error('clock_out') {{ $message }} @enderror</div>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="attendance-detail__row">
                            ...
                            <div class="attendance-detail__value">
                                ...
                                @else
                                    <textarea name="note">{{ old('note', $correction?->note) }}</textarea>
                                @endif
                                <div class="form__error">
                                    @error('note')
                                        {{ $message }}
